                ...
                if convergencias_apas:
                    ...
                    with st.expander("📚 O que significam esses números? (Clique para expandir)", expanded=False):
                        ...
                        **Analogia:** Imagine que você está tentando acertar o alvo de uma negociação. 
                        A média (42.8%) é seu melhor palpite, mas o IC 95% é a "zona de segurança" onde você 
                        espera que o alvo realmente esteja em 95 de cada 100 tentativas.
                        
                        **Interpretação:**
                        - IC 95%: [27.8% - 57.8%] é MUITO AMPLO 🔴
                        - Significa: "Não temos certeza onde a verdadeira média está"
                        - Interpretação: Colete mais dados para diminuir esse intervalo
                        
                        **Analogia numérica:**
                        - Se N = 5 (seu caso): IC = [27.8% - 57.8%] (intervalo ENORME de ±15%)
                        - Se N = 100: IC = [38% - 47.6%] (intervalo pequeno de ±5%)
                        ...
                        **O que isso significa:**
                        Para cada 100% de convergência média, há ±{:.1f}% de "oscilação"
                        → Cada negociação é MUITO diferente da outra
                        ...
                        **Seu caso:** {p_value_interpretation}
                        ...
                        **Interpretação:**
                        - Sem outliers: Dados "limpos" ✅
                        - Com outliers: Há algo inusitado acontecendo ⚠️
                        ...
                        **Como melhorar?** Colete {robustez['deficit']:.0f} mais APAs para atingir N = 30
                        ...
                        """.format(
                            ...
                            cv['valor'],
                            normalidade['interpretacao'],
                            '🟢 Nenhum outlier detectado' if not outliers['tem_outliers'] else f'🟡 {outliers["quantidade"]} outlier(s)',
                            n_amostras
                        ), 
                        unsafe_allow_html=True
                    )
