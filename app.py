...
<style>
    ...
    .card-green:hover {
        box-shadow: 0 15px 40px rgba(34, 197, 94, 0.25) !important;
    ...
    /* ==========================================
       AJUSTES EXTRAS PARA O FUNDO
       ========================================== */
    iframe[title="unicorn-bg-frame"] {
        position: fixed !important;
        inset: 0 !important;
        width: 100vw !important;
        height: 100vh !important;
...
# =========================================================
# FUNDO UNICORN NO BACKGROUND
# =========================================================
components.html("""
    <iframe
        title="unicorn-bg-frame"
