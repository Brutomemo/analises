...
def get_credentials():
    ...
    Railway usa variáveis de ambiente, não secrets.toml
    
    Retorna: (api_key, base_id)
    """
    # Railway usa variáveis de ambiente - sem necessidade de secrets.toml
...
def buscar_todas_apas():
    ...
    Usada por: app.py (linha 192)
        df_quali, status_q = airtable_link.buscar_dados_apa()
    
    Retorna:
        - DataFrame com todas as APAs
        - String de status (ex: "✅ 10 APAs carregadas")
    """
    try:
